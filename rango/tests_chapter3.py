...
#
# In order to run these tests, copy this module to your tango_with_django_project_Haipei/rango/ directory.
...
class Chapter3ProjectStructureTests(TestCase):
    ...
    def test_project_created(self):
        """
        Tests whether the tango_with_django_project_Haipei configuration directory is present and correct.
        """
        directory_exists = os.path.isdir(os.path.join(self.project_base_dir, 'tango_with_django_project_Haipei'))
        urls_module_exists = os.path.isfile(os.path.join(self.project_base_dir, 'tango_with_django_project_Haipei', 'urls.py'))
        
        self.assertTrue(directory_exists, f"{FAILURE_HEADER}Your tango_with_django_project_Haipei configuration directory doesn't seem to exist. Did you use the correct name?{FAILURE_FOOTER}")
...
class Chapter3IndexPageTests(TestCase):
    ...
    def setUp(self):
        ...
        self.project_urls_module = importlib.import_module('tango_with_django_project_Haipei.urls')
